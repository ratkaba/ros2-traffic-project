...
#ifndef _WIN32
# define DEPRECATED__turtlebot3_msgs__action__Patrol_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__turtlebot3_msgs__action__Patrol_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct Patrol_SendGoal_Event_
{
  using Type = Patrol_SendGoal_Event_<ContainerAllocator>;

  explicit Patrol_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit Patrol_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__turtlebot3_msgs__action__Patrol_SendGoal_Event
    std::shared_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__turtlebot3_msgs__action__Patrol_SendGoal_Event
    std::shared_ptr<turtlebot3_msgs::action::Patrol_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const Patrol_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using Patrol_SendGoal_Event =
  turtlebot3_msgs::action::Patrol_SendGoal_Event_<std::allocator<void>>;
...
struct Patrol_SendGoal
{
  ...
  using Event = turtlebot3_msgs::action::Patrol_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__turtlebot3_msgs__action__Patrol_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__turtlebot3_msgs__action__Patrol_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct Patrol_GetResult_Event_
{
  using Type = Patrol_GetResult_Event_<ContainerAllocator>;

  explicit Patrol_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit Patrol_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<turtlebot3_msgs::action::Patrol_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<turtlebot3_msgs::action::Patrol_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__turtlebot3_msgs__action__Patrol_GetResult_Event
    std::shared_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__turtlebot3_msgs__action__Patrol_GetResult_Event
    std::shared_ptr<turtlebot3_msgs::action::Patrol_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const Patrol_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using Patrol_GetResult_Event =
  turtlebot3_msgs::action::Patrol_GetResult_Event_<std::allocator<void>>;
...
struct Patrol_GetResult
{
  ...
  using Event = turtlebot3_msgs::action::Patrol_GetResult_Event;
};
