...
def generate_launch_description():
    ...
    x_pose = LaunchConfiguration('x_pose', default='14')
    y_pose = LaunchConfiguration('y_pose', default='18')
    z_pose = LaunchConfiguration('z_pose', default='0.12')
    yaw_angle = LaunchConfiguration('yaw_angle', default='-1.57')
    world_file = LaunchConfiguration('world', default='turtlebot3_world.sdf')
