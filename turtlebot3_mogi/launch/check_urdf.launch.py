...
def generate_launch_description():
    ...
    pkg_turtlebot3_mogi = FindPackageShare('turtlebot3_mogi')
    default_rviz_config_path = PathJoinSubstitution([pkg_turtlebot3_mogi, 'rviz', 'urdf.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'turtlebot3_gazebo',
